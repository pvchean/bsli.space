...
import {
  ...
  breakpoints,
} from "../__generated__/[news].[from-precision-manufacturing-to-heartwarming-initiatives]._index";
import {
  getResources,
  getPageMeta,
  getRemixParams,
  contactEmail,
} from "../__generated__/[news].[from-precision-manufacturing-to-heartwarming-initiatives]._index.server";
