...
import {
  ...
  breakpoints,
} from "../__generated__/[news].[successful-steam-turbine-trial-run-of-overseas-project]._index";
import {
  getResources,
  getPageMeta,
  getRemixParams,
  contactEmail,
} from "../__generated__/[news].[successful-steam-turbine-trial-run-of-overseas-project]._index.server";
