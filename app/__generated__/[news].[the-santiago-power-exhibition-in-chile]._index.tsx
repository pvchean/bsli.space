...
className={`w-element`}>
<h2
className={`w-element caand4 c1nljhgy c1e3pql6 c142cmue cn8st3g c1k51def c15inbko`}>
{"‭2025 Santiago Power Exhibition in Chile"}
</h2>
<div
...
<Time
country={"US"}
dateTime={"1740632400000"}
dateStyle={"medium"}
className={`w-time`} />
</div>
</div>
<div
className={`w-element ckz2uv6`}>
<Link
href={"/assets/SantiagoExhibition_ZqumpxwvepPDUuqBFRoo_.webp"}
className={`w-element cncijng c19tlt4t c13tvfy4 czpeyzf c8ql6pg ctxk4ps cvqux84 c13ijjzh c1q9de6q c2vggtm cmrz21 cpo7gcg c1ykyryb`}>
<Image
src={"/assets/SantiagoExhibition_ZqumpxwvepPDUuqBFRoo_.webp"}
className={`w-image cypm9hq`} />
</Link>
<p
id={"splitHere"}
className={`w-element c1tzvcmb`}>
{"‭This year, the 2025 Santiago Power Exhibition will be held from April 22nd to 25th in Chile. We sincerely extend this invitation to‬ ‭you and look forward to your presence.‬"}
</p>
<p
className={`w-element c1tzvcmb`}>
{"During this exhibition, we will comprehensively showcase our company's core products and advantageous projects. Whether it is‬ ‭our highly efficient and reliable steam turbines, our outstandingly performing turbo-generators, or our technologically advanced‬ ‭compressors, each product embodies our wisdom and craftsmanship. Additionally, we will be providing a detailed introduction to‬ ‭our highly anticipated EPC turnkey projects, presenting you with one-stop professional solutions!‬"}
{""}
<br />
{""}
{""}
...
<br />
{""}
{"‭The specific schedule of the exhibition is as follows:‬"}
{""}
<br />
{""}
{""}
...
<br />
{""}
{"‭Booth：3-C80 in Hall 3‬"}
</p>
</div>
<div
className={`w-element c1hwaj93 c69ybg3 c1y6ih9j c1knx7yf cti8d2k c1pe1t0k`}>
<Link
href={"/news/n45-full-condensing-steam-turbine-unit-loaded-for-shipment"}
...
<p
className={`w-element`}>
{"‭N4.5 Full Condensing Steam‬ ‭Turbine..."}
</p>
</Link>
<Link
href={"/news/from-precision-manufacturing-to-heartwarming-initiatives"}
className={`w-element cn8st3g cgk0c2y c1qz44hq cusiy40 c15lrgxi ccfvb11 ctxk4ps cvqux84 c13ijjzh c1q9de6q c19ex2t3 cob7zv3 ckej5u7 ci115mm c1mxkk2n ciojkvj c15yjsqm c18bmhvv c1c8zf5h c1mr2uf0 c1y0rexh cwqsszy cl15f9g c1a8v0ml c10s849d c1sjkjuo c7ofxtb cod9k44 c1dfx141 c101ftzv`}>
<h1
className={`w-element ctm807d c1nljhgy c1e3pql6 c1w1v2ay c1k51def`}>
{"Next"}
</h1>
<p
className={`w-element`}>
{"‭From Precision Manufacturing to‬"}
{""}
<br />
{""}
{"‭Heartwarming..."}
