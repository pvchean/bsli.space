...
<div
className={`w-element c1hwaj93 c1m6k3u4 c4obbyc c11df7z4`}>
<p
className={`w-element c1601kjc c3et322`}>
{"      Based on the strong technical strength, QNP can make maintenance plan and implement one-to-one service according to users' needs, so as to make customers' operation more secure, worry-free and professional."}
</p>
<p
className={`w-element c1601kjc c3et322`}>
{"      QNP mainly provides professional technical consultation, regular inspection and maintenance, operation analysis, fault diagnosis and other family doctor-style technical services for power plant operation, reducing power plant operation personnel and labor costs. Our professional services and fault prediction and prevention improve good operation time of equipment and improve economic benefits of power plants"}
</p>
</div>
</div>
<Image
...
loading={"lazy"}
alt={""}
className={`w-image cmexn04 c1eft87i c77lyzt c1ml14d5 c10s4plh c1s7i8t0 c1l9s2yj cx8nipw c1ie4089 cg7s5zj cy3p133 c1ypk2qu cveq8r1`} />
</section>
</Box>
<Slot>
<Fragment_1>
