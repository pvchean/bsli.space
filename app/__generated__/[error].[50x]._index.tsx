...
<Fragment_1>
<HtmlEmbed
code={"<script>\n  document.addEventListener('DOMContentLoaded', () => {\n    const params = new URLSearchParams(window.location.search);\n    const code = params.get('code');\n    let uri  = params.get('uri');\n\n    // update heading\n    const h = document.querySelector('.error-heading');\n    if (code && h) {\n      h.textContent = `Internal Server Error - ${code}`;\n    }\n\n    // update the URI paragraph\n    const u = document.querySelector('.error-uri-value');\n    if (uri && u) {\n      // prepend full domain\n      uri = 'https://qnpturbines.com' + decodeURIComponent(uri);\n      u.textContent = uri;\n    }\n\n    // set current UTC time\n    const t = document.getElementById('utc-time');\n    if (t) {\n      t.textContent = new Date().toUTCString();\n    }\n  });\n</script>"}
clientOnly={true}
className={`w-html-embed`} />
</Fragment_1>
</Slot>
<div
className={`w-element c1qq0nrw cpdpg5g c1hwaj93 cf4w2qm c1vxo7ql c1nte9kh cyakkz2 cp911us c1knx7yf cti8d2k cpk1khk cypm9hq c1ct96h3 cafzb5u c1ov5wtd c1l43p3t c1s7i8t0 c11df7z4 c4608q4 c1ozd5ub c1n7te52`}>
<h2
className={`w-element caand4 c1nljhgy c1e3pql6 c1w1v2ay cn8st3g c1k51def ${"error-heading"}`}>
{"internal server error - 50X"}
</h2>
<div
className={`w-element cypm9hq c1hwaj93 c11df7z4 c11sbn20 cmf4y3u`}>
<Text
data-ws-tag="div"
className={`w-text`}>
...
<Text
data-ws-tag="div"
className={`w-text c18p5r08 c12t1ny cgp6gzp c3fzz20 cq9ilfk ${"error-uri-value"}`}>
{"URI Place Holder"}
</Text>
<Text
data-ws-tag="div"
...
<div
className={`w-element c1hwaj93 cfs0eor c197046t cypm9hq ${"utc-time"}`}>
<Text
data-ws-tag="div"
id={"utc-time"}
className={`w-text c3fzz20 c1rvoic`}>
{"Time Place"}
</Text>
</div>
</div>
