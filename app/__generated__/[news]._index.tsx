...
let [CMSAssetURL, set$CMSAssetURL] = useVariableState<any>("https://cms.e2.lab512.org/assets/")
let CMSData = useResource("CMSData_1")
...
className={`w-element`}>
<Box
className={`w-box c17ls1cr c1hwaj93 c11df7z4 c69ybg3 c1oe0otl`}>
<Slot>
<Fragment_1>
<HtmlEmbed
...
<div
className={`w-element cfs0eor ca3qjfp c11df7z4 c1o6xupf`}>
<Image
src={"/assets/1__ysT_swn0btV98UiYTzvn.png"}
width={960}
height={540}
loading={"eager"}
id={"Top"}
className={`w-image c1knhv4u c4dvu2x c1ct96h3 cafzb5u c1ov5wtd c1l43p3t c1l9s2yj c1s7i8t0 c1sg3jzi c1oo5k7l c1pi0w14`} />
</div>
<Box
tag={"section"}
className={`w-box cjbow84 cuo5jv4 c1hwaj93 cf4w2qm c1vxo7ql c1nte9kh cyakkz2 cp911us c1knx7yf cti8d2k cpk1khk cypm9hq c1ct96h3 cafzb5u c1ov5wtd c1l43p3t c1s7i8t0 c11df7z4 cma995l c1ozd5ub c1n7te52 c15r62zr`}>
{CMSData?.data?.data?.map?.((collectionItem: any, index: number) =>
<Fragment key={index}>
<Link
href={`/newsarticle/${collectionItem?.slug}`}
aria-label={`View article titled "${collectionItem?.title}"`}
title={`/newsarticle/${collectionItem?.slug}`}
className={`w-element ckej5u7 cmn8rrp cypm9hq`}>
<div
className={`w-element c1ti7i5e cfrmrsc cypm9hq c1hwaj93 c3p3nc2 cmwfg6r cnv6yzu c7k04wh c1eft87i c77lyzt c1ml14d5 c10s4plh csnhjll cknl5p8 cmcv1hp c153xmxp c1xhwtmm c1wltgcv cgsgyfu chqodhp c1dw4hfr c1n602vg cb70grx c1368djy cm2viz1`}>
<div
className={`w-element cy8s2jd c1hwaj93 cfs0eor ca3qjfp cnhhwe8 c1qz44hq c15usro1 c15lrgxi ccfvb11 c1t417fb ci4pm0o`}>
<svg
xmlns={"http://www.w3.org/2000/svg"}
viewBox={"0 0 24 24"}
fill={"none"}
...
strokeLinecap={"round"}
strokeLinejoin={"round"}
className={`w-element cl675sb c1fiem78 ${"icon icon-tabler icons-tabler-outline icon-tabler-chevrons-right"}`}>
<path
stroke={"none"}
d={"M0 0h24v24H0z"}
fill={"none"}
...
<div
className={`w-element c1ti7i5e cpdpg5g c1eft87i c77lyzt c1ml14d5 c10s4plh c1hwaj93 cypm9hq c1ck8gbt c12t1ny cgp6gzp c93x7xj c18ywqyx c1qz44hq c15usro1 c15lrgxi ccfvb11 c1knx7yf cti8d2k cmcv1hp cfcbuqd cxv92ah c1wltgcv c1jbd0h4 c8gnqhr cxtzjxm cr261ds c1jrrhvj c1sg11op cb0lsga cietnwa c1gge0d3`}>
<Image
src={`${CMSAssetURL}${collectionItem?.image}`}
className={`w-image cbt6sn1 c1t417fb ci4pm0o c1txd6r0 c1l9s2yj ctxk4ps cvqux84 c13ijjzh c1q9de6q c184y4xx caihf4b cpo7gcg c1yj8vhl`} />
<div
className={`w-element c1hwaj93 c11df7z4 cp8jkcu`}>
<h1
className={`w-element ctm807d c1nljhgy c1e3pql6 c1w1v2ay c1k51def`}>
{collectionItem?.title}
</h1>
<Time
dateTime={collectionItem?.["date_created"]}
className={`w-time c1w8ck6s c1rvoic c1pmzsm9`} />
<p
className={`w-element ci3ft2j ckpd40v cmwfg6r cnv6yzu cchy9ce`}>
{`${collectionItem?.text}`}
</p>
</div>
</div>
