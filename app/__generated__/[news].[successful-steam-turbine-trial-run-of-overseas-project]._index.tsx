...
{"‭Successful Steam Turbine Trial Run of Overseas Project"}
</h2>
<Text
data-ws-tag="div"
...
<div
className={`w-element c1vj743w cti8d2k c4idxmm cpk1khk c1mzxru4 c82471s c1pe1t0k csgkqoj c1h1f8uy c9iyq6f cixq0oj c1o8cjkk c1uosxp0 c1v5li7h c1j95kyk cv9b0ge`}>
<Image
src={"/assets/TurbineRun_V3xtQe0bZyhg8jSuVUMYo.png"}
className={`w-image cypm9hq c1l9s2yj cy3p133`} />
<p
id={"splitHere"}
className={`w-element c17ao6ul c1b04qto c1701myc c17brmvf`}>
{"‭On September 14, 2024, a successful no-load test was done to‬ ‭our first ultra high-temperature and ultra high-pressure steam‬"}
{""}
<br />
{""}
{"‭turbine unit in our factory! Our team tested the steam‬ ‭turbine speed from its initial static state to an overspeed test.‬"}
{""}
<br />
{""}
{"‭"}
...
<br />
{""}
{"Overall, the steam turbine runs steadily with key indicators from‬ ‭the shaft vibration, shaft bush temperature, axial displacement,‬"}
{""}
<br />
{""}
{"‭etc. reaching the design standard.‬"}
{""}
<br />
{""}
{""}
