/* eslint-disable */
      ...
      import { Fragment as Fragment_1, Box as Box, Input as Input, Image as Image, HtmlEmbed as HtmlEmbed, Text as Text, Slot as Slot, Button as Button, Select as Select, Time as Time } from "@webstudio-is/sdk-components-react";
...
<Box
tag={"section"}
className={`w-box cjbow84 cuo5jv4 c1hwaj93 cf4w2qm c1vxo7ql cyjyvta cyakkz2 cp911us c1vj743w c17ni5cc cpk1khk cypm9hq c1ct96h3 cafzb5u c1ov5wtd c1l43p3t c1s7i8t0 c11df7z4 c1ozd5ub c1n7te52`}>
<Box
className={`w-box c1mmldci cbfiek cypm9hq cpk1khk c1hwaj93 c11df7z4 cugofm5 c1vxo7ql c1knx7yf cti8d2k c1veac25 c1nb0od0 ctm807d c1njmdp4 cw60snx cyys4c6 cznybda`}>
<div
className={`w-element`}>
<h2
className={`w-element caand4 c1nljhgy c1e3pql6 c6drtsu cn8st3g c1k51def c15inbko`}>
{"​From Precision Manufacturing to Heartwarming Initiatives"}
</h2>
<div
className={`w-element c3ngsta c1pmzsm9 cqd1sn9`}>
<Text
data-ws-tag="div"
className={`w-text c3ztxkm`}>
{"​Publish Date:​ ​"}
</Text>
<Time
country={"US"}
dateTime={"1740978000000"}
dateStyle={"medium"}
className={`w-time`} />
</div>
</div>
<div
className={`w-element ckz2uv6 ${"split-paragraphs"}`}>
<Image
src={"/assets/SnowImage_ezKBW9lHiBKnjeUiC-4it.png"}
className={`w-image cncijng c19tlt4t c13tvfy4 czpeyzf c8ql6pg ctxk4ps cvqux84 c13ijjzh c1q9de6q c2vggtm cmrz21 cpo7gcg c1ykyryb`} />
<p
className={`w-element c1b04qto c1tzvcmb c1701myc c17brmvf ${"split-paragraph"}`}>
{"​On March 3rd, 2025, a heavy snowfall brought us a beautiful sight of everything covered in white. However, this became an​ ​immediate inconvenience to the company's factory area. In order to ensure employee safety in traveling and normal production​ ​activities, we quickly organized all employees to carry out a vigorous snow-clearing operation.​"}
</p>
<p
className={`w-element c1b04qto c1tzvcmb ${"split-paragraph"}`}>
{"Early this morning, our company's leaders led teams of employees from various departments to pick up tools such as shovels and​ ​brooms to start the snow-clearing process. Everyone had a crucial position and cooperated tacitly. Some employees were​ ​responsible for removing the thick snow on the main roads, while others focused on clearing the remaining snow on the sidewalks​ ​and ladders. Additionally, many took the initiative to clean the green belts along the roads within the factory area; this ensured our​ ​green plants would not be crushed by the snow. Over an hour of hard work, the main roads in the company's factory area were​ ​cleared, opening up a safe passage for employee travel and vehicle passage.​"}
</p>
<p
className={`w-element c1b04qto c1tzvcmb ${"split-paragraph"}`}>
{"​The roaring of our steam turbine symbolizes the heartbeat of a powerful industrial nation, while the busy figures clearing the snow​ ​convey the warmth of responsibility. This snow-clearing initiative not only showcases the united, cooperative, and positive spirit of​ ​employees from all departments of QNP Steam Turbines but also vividly demonstrates the company's profound concern for​ ​employees' safety. Looking ahead, we will consistently uphold this spirit, proactively tackle various challenges, and work tirelessly​ ​for the growth of the enterprise and the well-being of our team.​"}
</p>
</div>
<div
className={`w-element c1hwaj93 c69ybg3 c1y6ih9j c1knx7yf cti8d2k c1pe1t0k`}>
<Link
href={"/news/the-santiago-power-exhibition-in-chile"}
aria-label={"Previous Article"}
className={`w-element cn8st3g cgk0c2y c1qz44hq cusiy40 c15lrgxi ccfvb11 ctxk4ps cvqux84 c13ijjzh c1q9de6q c19ex2t3 cob7zv3 ckej5u7 ci115mm ciojkvj c15yjsqm c18bmhvv c1c8zf5h c1mr2uf0 c1y0rexh cwqsszy cl15f9g c1a8v0ml c10s849d c1sjkjuo c7ofxtb cod9k44 c101ftzv`}>
<h1
...
<p
className={`w-element`}>
{"2025 Santiago Power Exhibition..."}
</p>
</Link>
</div>
</Box>
