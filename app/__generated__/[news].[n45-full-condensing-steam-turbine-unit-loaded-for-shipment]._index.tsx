...
className={`w-element`}>
<h2
className={`w-element caand4 c1nljhgy c1e3pql6 c1w1v2ay cn8st3g c1k51def cb7g17o c15inbko`}>
{"‭N4.5 Full Condensing Steam Turbine Unit Loaded for Shipment"}
</h2>
<Text
data-ws-tag="div"
className={`w-text c1pmzsm9`}>
{"​Publish Date:​​‬‭ 2025-01-14‬​"}
</Text>
</div>
<div
className={`w-element c1vj743w cti8d2k c4idxmm cpk1khk c1mzxru4 c82471s c1pe1t0k csgkqoj c1h1f8uy c9iyq6f cixq0oj c1o8cjkk c1uosxp0 c1j95kyk cv9b0ge`}>
<Image
src={"/assets/n4.5Ready_VWn3dm9UT8n1DsuHm-E0y.webp"}
width={1600}
height={1531}
className={`w-image cypm9hq c1l9s2yj cy3p133`} />
<p
id={"splitHere"}
className={`w-element c17ao6ul c1b04qto c1m8akzc c1herbsb c1701myc c17brmvf`}>
{"‭On January 14, 2025, two sets of N4.5 full condensing steam‬ ‭turbine generator units and auxiliary equipment from QNP were‬ ‭loaded for shipping to the project site, to be installed and‬ ‭commissioned!‬"}
</p>
</div>
<div
className={`w-element c1hwaj93 c69ybg3 c1y6ih9j c1knx7yf cti8d2k c1pe1t0k`}>
<Link
href={"/news/successful-steam-turbine-trial-run-of-overseas-project"}
...
<p
className={`w-element`}>
{"‭Successful Steam Turbine Trial Run..."}
</p>
</Link>
<Link
href={"/news/the-santiago-power-exhibition-in-chile"}
className={`w-element cn8st3g cgk0c2y c1qz44hq cusiy40 c15lrgxi ccfvb11 ctxk4ps cvqux84 c13ijjzh c1q9de6q c19ex2t3 cob7zv3 ckej5u7 ci115mm c1mxkk2n cbfiek ciojkvj c15yjsqm c18bmhvv c1c8zf5h c1mr2uf0 c1y0rexh cwqsszy cl15f9g c1a8v0ml c10s849d c1sjkjuo c7ofxtb cod9k44 c1dfx141 c101ftzv`}>
<h1
className={`w-element ctm807d c1nljhgy c1e3pql6 c1w1v2ay c1k51def`}>
{"Next"}
</h1>
