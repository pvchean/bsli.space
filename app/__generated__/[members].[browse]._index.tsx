...
<Select
name={"searchScope"}
value={system?.search?.searchScope}
...
<Link
href={"/members/" + collectionItem?.["osu_ndn"]}
prefetch={"intent"}
className={`w-link ch72vge c956szp c1xkkw6h c9ffb6f`}>
<div
id={collectionItemKey}
className={`w-element c1fsvg17 cp0jmbs c1412oo6 cxkx6pe c1jggrh7 cov3pab c1n7i0rg chyxmce csgp7p3 c1qdzuay c1lkbaaj cx8n37q ce5jf0f cnbmf4z ctkbqoa c9ffb6f cmauqv c1fzb25u c1wvwf6y c1j4r0zr cwsyufx cy9492r c1x6vc8x coc50eh c1sg2ohq cu74mob`}>
<div
className={`w-element`}>
<Image
src={`${collectionItem?.headshot != null ? CMS_Asset_URL + collectionItem?.headshot : URL_Member_UnknownHeadshot}`}
...
<h2
className={`w-element c1iebxzq cr340of c1iwa1os cbewb4j cj20esf c3eev2k`}>
{"No member found"}
</h2>
<p
